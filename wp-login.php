...
<link rel="stylesheet" id="dashicons-css" href="/wp-includes/css/dashicons.min.css?ver=5.8.3" media="all">
<link rel="stylesheet" id="buttons-css" href="/wp-includes/css/buttons.min.css?ver=5.8.3" media="all">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to dragondebt</a>		</p>
			</div>
...
<script src="/wp-admin/js/password-strength-meter.min.js?ver=5.8.3" id="password-strength-meter-js"></script>
<script src="/wp-includes/js/underscore.min.js?ver=1.13.1" id="underscore-js"></script>
<script id="wp-util-js-extra">
var _wpUtilSettings = {"ajax":{"url":"\/wp-admin\/admin-ajax.php"}};
</script>
<script src="/wp-includes/js/wp-util.min.js?ver=5.8.3" id="wp-util-js"></script>
...
<script src="/wp-admin/js/user-profile.min.js?ver=5.8.3" id="user-profile-js"></script>
	<script>
